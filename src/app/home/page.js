        ...
        <div className='container py-[80px]'>
          <div className='flex justify-between'>
            <div className='w-[48%] py-[50px]'>
                ...
                <span className='rounded-[4px] gap-[4px] px-[12] py-[5] logo-section flex  bg-[#EAE6DC]'> <span>Backed by</span> <Image src={'/y-log.svg'} height={20} width={20} alt='img'></Image> <span>Combinator (W23)</span> </span>
